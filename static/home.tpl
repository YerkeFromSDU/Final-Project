                      ...
                      <form v-on:submit.prevent>
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                            <button class="btn custom-button" :class="{'btn-success' : !enableEdit, 'btn-warning' : enableEdit}" type="button"  v-on:click="addTodo" style="background: #30d5c8; border: none;"><span :class="{'fa fa-plus' : !enableEdit, 'fa fa-edit' : enableEdit}"></span></button>
                          </span>
                        </div>
                      </form>
                      <ul class="list-group">
                        <li class="list-group-item" :class="{ 'checked': todo.completed, 'not-checked': !todo.completed }" v-for="(todo, todoIndex) in todos" v-on:click="toggleTodo(todo, todoIndex)">
                            ...
                            <div class="btn-group float-right" role="group" aria-label="Basic example">
                              <button type="button" class="btn btn-success btn-sm custom-button" v-on:click.prevent.stop v-on:click="editTodo(todo, todoIndex)" style="background: #30d5c8; border: none;"><span class="fa fa-edit"></span></button>
                              <button type="button" class="btn btn-danger btn-sm custom-button" v-on:click.prevent.stop v-on:click="deleteTodo(todo, todoIndex)" style="background: #b491c8; border: none;" ><span class="fa fa-trash"></span></button>
                            </div>
                        </li>
                      </ul>
                  </div>
